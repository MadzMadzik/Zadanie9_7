var newGameBtn = document.getElementById('js-newGameButton'); //pobieranie elementu js-neGamebutton

newGameBtn.addEventListener('click', newGame); //po lkiknieciu odpalimy funkcje newGame
